...
@{
    ...
    Description = 'Microsoft PowerBI PowerShell - Workspace cmdlets for Microsoft PowerBI'
    ...
    CmdletsToExport = @('Get-PowerBIWorkspace', 'Add-PowerBIWorkspaceUser', 'Remove-PowerBIWorkspaceUser', 'Set-PowerBIWorkspace', 'Restore-PowerBIWorkspace')

    # Variables to export from this module
    # VariablesToExport = '*'

    # Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
    AliasesToExport = @('Add-PowerBIGroupUser', 'Get-PowerBIGroup', 'Remove-PowerBIGroupUser', 'Set-PowerBIGroup', 'Restore-PowerBIGroup')
