...
namespace Microsoft.PowerBI.Commands.Workspaces.Test
{
    ...
    public class GetPowerBIWorkspaceTests
    {
        ...
        [TestMethod]
        public void GetWorkspacesOrganizationScopeSupportsAllWithId()
        {
            // Arrange
            var id = Guid.NewGuid();
            var filter = $"id eq '{id}'";
        ...
        [TestMethod]
        public void GetWorkspacesOrganizationScopeSupportsAllWithName()
        {
            // Arrange
            var name = "Test";
            var filter = $"tolower(name) eq '{name.ToLower()}'";
        ...
        [TestMethod]
        public void GetWorkspacesAllDoesNotSupportIndividualScope()
        {
            // Arrange
            var user = "JOHN@contoso.com";
            var filter = $"users/any(u: tolower(u/emailAddress) eq '{user.ToLower()}')";
        ...
        [TestMethod]
        public void GetWorkspacesAllDoesNotSupportFirstAndSkip()
        {
            // Arrange
            var user = "JOHN@contoso.com";
            var filter = $"users/any(u: tolower(u/emailAddress) eq '{user.ToLower()}')";
